...
TODO:
1. Импортировать данные в Базу;
2. Подсчитать количество преподавателей на каждую дисциплину;
3. Для каждого преподавателя вывести количество дисциплин, которые он может вести;
4. Подсчитать количество преподавателей для каждого направления обучения;
5. Подсчитать количество дисциплин, которое ведется на каждом направлении;
6. Для каждого направления вывести общее количество часов за все обучение;
